 ...
 */
__global__ void
CudaKernel(cudaPitchedPtr *g_idata, float *g_odata, size_t ntimepts, size_t width, size_t height)
{
 ...
 */
extern "C" void 
executeCudaKernel(unsigned int threadsPerBlock, unsigned int  blocksPerGrid, cudaPitchedPtr *d_idata, float *d_odata, size_t ntimepts, size_t width, size_t height)
{
